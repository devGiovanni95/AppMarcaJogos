...
import ListItem from '../components/ListItemEnter'; // Certifique-se de ajustar o caminho conforme a sua estrutura de pastas
...
const Home = () => {
    const renderItem = ({ item }:any) => (
        <ListItem criador={item.criador} nome={item.nome} descricao={item.descricao} />
    );
